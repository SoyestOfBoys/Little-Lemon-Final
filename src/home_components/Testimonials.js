  ...
  return (
    <body className="testimonials">
      ...
      <div className="testimonial 1">
        ...
        <div className='NameBox'> <h3>Sophia Patel</h3>
        <div className='Stars'><img className='Star' src={star} alt='star' /><img className='Star' src={star} alt='star' /><img className='Star' src={star} alt='star' /><img className='Star' src={star} alt='star' /><img className='Star' src={star} alt='star' /></div></div>
